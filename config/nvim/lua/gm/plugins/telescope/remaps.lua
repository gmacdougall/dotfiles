...
local functions = require("gm.plugins.telescope.functions")

r.noremap("n", "<leader>pp", "<cmd>Telescope projects<CR>", "Projects")
r.noremap("n", "<leader>fg", builtin.live_grep, "Live grep")
...
r.noremap("n", "<leader>e", builtin.git_files, "Find git files")
